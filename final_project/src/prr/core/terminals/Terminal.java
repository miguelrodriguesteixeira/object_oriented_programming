...
public abstract class Terminal implements Serializable {
    ...
    public Collection<Communication> removeCommunicationsByValue(int valor) {
        ArrayList<Communication> communications = new ArrayList<>(_madeCommunications.values());
        ArrayList<Communication> commInf = new ArrayList<>();
